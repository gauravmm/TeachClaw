...
from teachclaw.bus import MessageAddress, MessageBus
from teachclaw.channels.base import BaseChannel
from teachclaw.channels.telegrm import commands, inbound, outbound, reactions, typing_loop
...
class TelegramChannel(BaseChannel):
    ...
    - Mermaid blocks in the outbound text are rendered to PNG via
      ``teachclaw.rendering.mermaid`` and posted in order.
